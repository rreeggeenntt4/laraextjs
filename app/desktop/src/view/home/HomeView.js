Ext.define('laraextjs.view.home.HomeView',{
	xtype: 'homeview',
	cls: 'homeview',
  ...
  scrollable: true,
  html: `<h1>Hello</h1><div style="user-select: text !important;">Welcome to the Ext JS Modern Desktop Template Application!
<br><br>
